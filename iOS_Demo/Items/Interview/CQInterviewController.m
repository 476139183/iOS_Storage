...
@interface CQInterviewController () <UITableViewDataSource, UITableViewDelegate>
...
- (NSMutableArray *)dataArray {
    if (!_dataArray) {
        ...
        // 加载本地数据
        NSString *catalogPath = [[NSBundle mainBundle] pathForResource:@"interview_contents" ofType:@"plist"];
