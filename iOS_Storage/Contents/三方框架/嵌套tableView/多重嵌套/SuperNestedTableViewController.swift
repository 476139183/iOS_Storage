//
//  SuperNestedTableViewController.swift
//  iOS_Storage
//
...
class SuperNestedTableViewController: CQBaseViewController, JXSegmentedViewDelegate, JXSegmentedListContainerViewDataSource {
    
    private lazy var controllers: [NestedTableViewController] = {
        return [NestedTableViewController(), NestedTableViewController(), NestedTableViewController()]
    }()
