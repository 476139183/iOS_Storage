...
class JXMixViewController: CQBaseViewController, JXSegmentedViewDelegate, JXSegmentedListContainerViewDataSource {
    ...
    /// segmentedView的数据源
    private lazy var segmentedDataSource: CQSegmentedDataSource = {
        let dataSource = CQSegmentedDataSource()
