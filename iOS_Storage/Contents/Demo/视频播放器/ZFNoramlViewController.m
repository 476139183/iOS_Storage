...
//    NSString *URLString = @"https://dingstock.oss-cn-shanghai.aliyuncs.com/video/BP.mp4";
...
- (NSArray<NSURL *> *)assetURLs {
    if (!_assetURLs) {
            _assetURLs = @[[NSURL URLWithString:@"https://dingstock.oss-cn-shanghai.aliyuncs.com/video/BP.mp4"],
